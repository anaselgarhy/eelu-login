use reqwest::{Client,ClientBuilder,header::{HeaderMap,HeaderValue,HeaderName,USER_AGENT,COOKIE,REFERER,CONTENT_TYPE}};
...
pub fn sis_eelu_request_headers(cookie:Option<&String>)->HeaderMap{
    ...
    headers.insert(USER_AGENT, HeaderValue::from_static("0xCrypt00o - EELU Moodle Login"));
    ...
    headers.insert(REFERER, HeaderValue::from_static("http://sis.eelu.edu.eg/static/PortalStudent.html"));
    match cookie {
        Some(value)=>{
